...
<section id="page">
    ...
    <section class="home_page_hero">
        <img src="../public/images/Foto_Principal.jpg" alt="Woman tying her shoelaces in a gym"
            class="home_page_hero-background-image">
                ...
                <div class="swiper-wrapper">
                    ...
                    <?php foreach ($categories as $category): ?>
                        <div class="swiper-slide home_page_category-slide">
                            <a href="/../includes/category_product.php?id=<?= $category['id'] ?>"
                                class="home_page_slide-link"></a>
                            <div class="home_page_category-image-container">
                                <img src="../public/uploads/<?= $category['image'] ?>" alt="Fitness Wear Category"
                                    class="home_page_category-image">
                            </div>
                    ...
                    <div class="home_page_product-card">
                        ...
                        <div class="home_page_product-image-container">
                            <img src="/public/uploads/products/<?= $product['product_image'] ?>"
                                alt="Premium Sports Legging" class="home_page_product-image">
    ...
    <section class="home_page_about-section">
        <div class="home_page_about-container">
            <div class="home_page_about-image-wrapper">
                <img src="../public/images/Foto_Principal.jpg" alt="Woman in athletic wear posing"
                    class="home_page_about-image">
            </div>
            <div class="home_page_about-content">
                <h1 class="home_page_section-title">Experimente a Diferença da Valgrit: Qualidade Que Se Sente em Cada
                    Fibra!</h1>
                <p>
                    ...
                    que cede ou desbota após algumas utilizações!
                    <br /><br />
                    ...
                    mais exigentes. Sinta a diferença de um conforto que o impulsiona.
                    <br /><br />
                    Estilo Que Inspira: Com designs modernos e cortes que realçam a sua silhueta, a roupa Valgrit fará
                    com que se sinta confiante e motivado. Porque sabemos que quando se sente bem, treina melhor.
                    <br /><br />
                    Investimento Inteligente: Ao escolher Valgrit, está a investir em peças que o acompanharão nas suas
                    jornadas desportivas por anos. Menos compras, mais treinos, mais resultados.
