    ...
    <div class="profile-container">
        <div class="profile-header">
            <div class="profile-avatar-wrapper">
                <img src="<?= $user['image'] ?>" alt="Profile Picture" class="profile-avatar" onerror="this.onerror=null;this.src='https://placehold.co/120x120/cccccc/333333?text=N/A';">
            </div>
        ...
        <div class="button-wrapper">
            <a href="?page=edit-profile" class="edit-button">Edit Profile</a>
            <a href="auth/logout.php" class="logout-edit-button"><i class="fa-solid fa-arrow-right-from-bracket"></i> Logout</a>
        </div>
    </div>
</section>